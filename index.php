<?php
    ...
    switch ($path) {
        case '/testingv3/':
            include './home.php';
            break;
        case '/testingv3/addUser':
            $utilCtrl->insertUser();
            break;
        case '/testingv3/connexion':
            $utilCtrl->connexionUser();
            break;
        case '/testingv3/deconnexion':
            $utilCtrl->deconnexionUser();
            break;
        case '/testingv3/test':
            include './test.php';
            break;
        case '/testingv3/api/addTest':
            $apiTestsCtrl->addTestsToJson();
            break;
        case '/testingv3/addTest':
